...
class Sales_model extends CI_Model
{
	...
	public function getExportCustomerBalance($id=null, $wh=null)
    {
		$this->db
			...
			users.username AS saleman, sales.sale_status, 
  ...
  //           ->group_by('deliveries.id')
    ...
    {
		$this->db->select('id, date, reference_no, supplier,status, grand_total, paid, (grand_total-paid) as balance, payment_status, biller_id');
