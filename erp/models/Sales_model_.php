...
class Sales_model extends CI_Model
{
  ...
  //           ->group_by('deliveries.id')
	...
	// 	// $this->erp->print_arrays($id);
 //        $this->db->select("currencies.rate")
 ...
 //        return FALSE;
	// }
	public function getcurrentcy($id) {
		$this->db->select('currencies.rate')->from('products')
		->join('currencies', 'currencies.code = products.currentcy_code', 'left')
