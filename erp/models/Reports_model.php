...
class Reports_model extends CI_Model
{
    ...
    public function getSalemanReportDetail($saleman_id, $start_date2 = NULL, $end_date2 = NULL, $saleman2 = NULL, $sales_type2 = NULL){
...
*/
	...
	public function getSupplierByID($id,$start_date,$end_date){
   ...
   public function getCustomersByID($id=null, $wh=null) {
	...
	public function getWarePur($wid,$warehouse,$product,$category,$biller){
		$this->db->select("erp_warehouses.id,erp_warehouses.name")
				 ...
				 ->where(array('erp_purchase_items.status !='=> 'pending', 'erp_purchase_items.product_type !=' => 'service'));
		if ($warehouse) {
