...
class Purchases extends MY_Controller
{
    ...
    public function modal_view($purchase_id = null)
    {
        ...
        $this->data['inv'] = $inv;
		if($inv->type_of_po == 'exp') {
			$this->data['po_expense'] = $this->purchases_model->getPurchaseExpenses($inv->reference_no);
			$this->data['sales'] 	  = $this->sales_model->getSalesById($inv->sale_id);
		}
        $this->data['payments'] = $this->purchases_model->getPaymentsForPurchase($purchase_id);
        $this->data['created_by'] = $this->site->getUser($inv->created_by);
        $this->data['updated_by'] = $inv->updated_by ? $this->site->getUser($inv->updated_by) : null;
