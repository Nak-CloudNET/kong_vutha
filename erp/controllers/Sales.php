...
class Sales extends MY_Controller
{
        ...
        if ($this->form_validation->run() == true) {
            ...
            if (!empty($_POST['val'])) {
                ...
                if ($this->input->post('form_action') == 'export_excel' || $this->input->post('form_action') == 'export_pdf') {
                    ...
                    $this->excel->getActiveSheet()->setCellValue('E1','Customer Balance');					
                    ...
                    $this->excel->getActiveSheet()->SetCellValue('D3', lang('project'));
                    $this->excel->getActiveSheet()->SetCellValue('E3', lang('customer'));
                    $this->excel->getActiveSheet()->SetCellValue('F3', lang('sale_status'));
                    $this->excel->getActiveSheet()->SetCellValue('G3', lang('grand_total'));
                    $this->excel->getActiveSheet()->SetCellValue('H3', lang('return'));
                    $this->excel->getActiveSheet()->SetCellValue('I3', lang('paid'));
                    $this->excel->getActiveSheet()->SetCellValue('J3', lang('deposit'));
                    $this->excel->getActiveSheet()->SetCellValue('K3', lang('discount'));
                    $this->excel->getActiveSheet()->SetCellValue('L3', lang('balance'));
                    $this->excel->getActiveSheet()->SetCellValue('M3', lang('payment_status'));
                    
                    $row = 4;
                    foreach ($_POST['val'] as $id) {
                        $row_data = $this->sales_model->getExportCustomerBalance($id);
                        $this->excel->getActiveSheet()->SetCellValue('A' . $row, $row_data->date);
                        $this->excel->getActiveSheet()->SetCellValue('B' . $row, $row_data->due_date);
                        $this->excel->getActiveSheet()->SetCellValue('C' . $row, $row_data->reference_no);
                        $this->excel->getActiveSheet()->SetCellValue('D' . $row, $row_data->biller);
                        $this->excel->getActiveSheet()->SetCellValue('E' . $row, $row_data->customer);
                        $this->excel->getActiveSheet()->SetCellValue('F' . $row, $row_data->sale_status);
                        $this->excel->getActiveSheet()->SetCellValue('G' . $row, $this->erp->formatMoney($row_data->amount));
                        $this->excel->getActiveSheet()->SetCellValue('H' . $row, $this->erp->formatMoney($row_data->return_sale));
                        $this->excel->getActiveSheet()->SetCellValue('I' . $row, $this->erp->formatMoney($row_data->paid));
                        $this->excel->getActiveSheet()->SetCellValue('J' . $row, $this->erp->formatMoney($row_data->deposit));
                        $this->excel->getActiveSheet()->SetCellValue('K' . $row, $this->erp->formatMoney($row_data->discount));
                        $this->excel->getActiveSheet()->SetCellValue('L' . $row, $this->erp->formatMoney($row_data->balance));
                        $this->excel->getActiveSheet()->SetCellValue('M' . $row, $row_data->payment_status);
						$this->excel->getActiveSheet()->getStyle('G' . $row . ':L' . $row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
					...
					$this->excel->getActiveSheet()->getStyle('G'.$new_row.':L'.$new_row)->getBorders()->getTop()->setBorderStyle(PHPExcel_Style_Border:: BORDER_THIN);
					$this->excel->getActiveSheet()->getStyle('G'.$new_row.':L'.$new_row)->applyFromArray($footer_style);
					
					$this->excel->getActiveSheet()->SetCellValue('G' . $row, $this->erp->formatMoney($total_amount));
					$this->excel->getActiveSheet()->SetCellValue('H' . $row, $this->erp->formatMoney($total_return_sale));
					$this->excel->getActiveSheet()->SetCellValue('I' . $row, $this->erp->formatMoney($total_paid));
					$this->excel->getActiveSheet()->SetCellValue('J' . $row, $this->erp->formatMoney($total_deposit));
					$this->excel->getActiveSheet()->SetCellValue('K' . $row, $this->erp->formatMoney($total_discount));
					$this->excel->getActiveSheet()->SetCellValue('L' . $row, $this->erp->formatMoney($total_balance));
                    ...
                    if ($this->input->post('form_action') == 'export_pdf') {
						...
						$this->excel->getActiveSheet()->getStyle('A1:M1')->applyFromArray($header_style);
						$this->excel->getActiveSheet()->getStyle('A2:M2')->applyFromArray($header_style);
						$this->excel->getActiveSheet()->getStyle('A3:M3')->applyFromArray($header_style);
						$rw = 4;
						foreach ($_POST['val'] as $id) {
							$this->excel->getActiveSheet()->getStyle("G" . $rw . ":L" . $rw)->getBorders()->getBottom()->setBorderStyle(PHPExcel_Style_Border::BORDER_MEDIUM);
							...
							$this->excel->getActiveSheet()->getStyle("K" . $rw)->getBorders()->getRight()->setBorderStyle(PHPExcel_Style_Border::BORDER_MEDIUM);
							$this->excel->getActiveSheet()->getStyle("L" . $rw)->getBorders()->getRight()->setBorderStyle(PHPExcel_Style_Border::BORDER_MEDIUM);
							$this->excel->getActiveSheet()->getStyle("G" . $rw . ":L" . $rw)->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
							$rw++;
						}			
                    ...
                    if ($this->input->post('form_action') == 'export_excel') {
                        ...
                        $this->excel->getActiveSheet()->getStyle("A1:M1")->getFont()->setSize(15);
                        $this->excel->getActiveSheet()->getStyle("A2:M2")->getFont()->setSize(12);
                        $this->excel->getActiveSheet()->getStyle('A2:M2')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
						$this->excel->getActiveSheet()->getStyle("A3:M3")->getFont()->setSize(12);
	...
	function combine_payment_pur()
    {
        ...
        if ($this->form_validation->run() == true) {
			...
			$biller_id_arr		= $this->input->post('biller_arr');
			$amount_paid_arr 	= $this->input->post('amount_paid_line');
			...
			foreach($sale_id_arr as $sale_id){
				...
				$reference_no = $this->input->post('reference_no') ? $this->input->post('reference_no') : $this->site->getReference('sp', $biller_id_arr[$i]);
