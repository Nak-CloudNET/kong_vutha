...
class Employees extends MY_Controller
{
	...
	function add()
    {
        ...
        $this->data['title'] = "Create Employees";
        $this->form_validation->set_rules('emp_code', lang("emp_code"), 'trim|required|is_unique[users.emp_code]');
        $this->form_validation->set_rules('email', lang("email"), 'trim|is_unique[users.email]');
      //  $this->form_validation->set_rules('status', lang("status"), 'trim|required');
       // $this->form_validation->set_rules('group', lang("group"), 'trim|required');
        ...
        if ($this->form_validation->run() == true) {
          ...
          //  $username = strtolower($this->input->post('username'));
           ...
           /// $password = $this->input->post('password');
			...
			//$this->erp->print_arrays($additional_data);
        }
        if ($this->form_validation->run() == true && $this->employee_modal->addEmployee($additional_data)) {
