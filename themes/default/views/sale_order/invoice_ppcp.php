		...
		<div class="col-xs-12" style="width: 794px;">
			...
			<div class="col-sm-3 col-xs-3">
				<?php if(!empty($biller->logo)) { ?>
					<img src="<?= base_url() ?>assets/uploads/logos/<?= $biller->logo; ?>" style="width: 165px; margin-left: 25px;margin-top:-18px !important;" />
				<?php } ?>
			</div>
					...
					<table class="table table-bordered" style="margin-top: 10px;">
						<tbody style="font-size: 11px;">
							<tr class="thead" style="background-color: #444 !important; color: #FFF !important;">
								...
								<th style="width: 100px !important;">កូដទំនិញ<br /><?= strtoupper(lang('code')) ?></th>
								<th style="width: 200px !important;">បរិយាយមុខទំនិញ<br /><?= strtoupper(lang('description'))?></th>
								<th style="width:  52px !important;">ខ្នាត<br /><?= strtoupper(lang('unit')) ?></th>
								<th style="width:  70px !important;">ចំនួន<br /><?= strtoupper(lang('qty')) ?></th>
								<th style="width:  90px !important;">តម្លៃ<br /><?= strtoupper(lang('unit_price')) ?></th>
								
								<?php if ($Settings->product_discount) { ?>
									<th style="width: 60px;">បញ្ចុះតម្លៃ<br /><?= strtoupper(lang('discount')) ?></th>
								<?php } ?>
								<?php if ($Settings->tax1) { ?>
									<th style="width: 70px;">ពន្ធទំនិញ<br /><?= strtoupper(lang('tax')) ?></th>
								<?php } ?>
								<th style="width:60px;">តម្លៃសរុបទំនិញ<br /><?= strtoupper(lang('subtotal')) ?></th>
							</tr>
							<?php 
								$no = 1;
								foreach ($rows as $row) {
							...
							?>
								<tr>
									...
									<?php } ?>
									 <td style="text-align:right;vertical-align:middle;"><?= $row->subtotal !=0? '$' .$this->erp->formatMoney($row->subtotal):$free;$total += $row->subtotal;
										?>
									</td>
								</tr>
			...
			<div id="footer" class="row">
				...
				<div class="col-sm-4 col-xs-4">
					<center>
						<p style="margin-bottom:65px !important;font-weight:bold !important; font-size: 13px !important">Prepare By(Rep)</P>
						<p style="font-weight:bold !important;">Date:______/_______/______</p>
					</center>
				</div>
				<div class="col-sm-4 col-xs-4">
					<center>
						<p style="margin-bottom:65px !important;font-weight:bold !important; font-size: 13px !important">Check By Suppervisor</P>
						<p style="font-weight:bold !important;">Date:______/_______/______</p>
					</center>
				</div>
				<div class="col-sm-4 col-xs-4">
					<center>
						<p style="margin-bottom:65px !important;font-weight:bold !important; font-size: 13px !important">Approve By Sale Manager</P>
						<p style="font-weight:bold ;">Date:______/_______/______</p>
					</center>
				</div>
			</div>
			<footer></footer>
