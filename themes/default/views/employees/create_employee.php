                    ...
                    <div class="col-md-12">
                        <div class="col-md-5">
							...
							<div class="form-group">
                                <?php echo lang('employee_code', 'employee_code'); ?> <b>*</b>
                                <div class="controls">
                                    <?php echo form_input('emp_code', '', 'class="form-control" id="emp_code" required="required"'); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                echo form_dropdown('gender', $ge, (isset($_POST['gender']) ? $_POST['gender'] : ''), 'class="tip form-control" id="gender" data-placeholder="' . lang("select") . ' ' . lang("gender") . '" ');
                                ?>
                            </div>
