		...
		<table class="table table-bordered table-hover" border="1">
			<thead>
				<tr>
					...
					<th style="width:10% !important;font-size:17px !important;"class="text-center"><?=lang('សរុប </br> Amount')?></th>
				</tr>
			</thead>
			<tbody>
				<?php //for($i=0; $i<20; $i++){
				...
				<tr>
					...
					<td style=" text-align:center; vertical-align:middle;"><?=$row->wpiece;?></td>
					<td style=" text-align:center; vertical-align:middle;">
				...
				<tr>
					<td colspan="6" rowspan="<?= $rSpan ?>" style="text-align:left; font-weight: bold;border-left:1px solid white!important;">
						<?=lang('note').':';?>
					</td>
				...
				<tr>
					<!-- <td colspan="6" style="text-align:center; vertical-align:middle;"></td> -->
					<td colspan="2"style="text-align:left; vertical-align:middle;"><?='វេចខ្ចប់ / '.lang('shipping').':'?></td>
					<td style="text-align:left; vertical-align:middle;">
