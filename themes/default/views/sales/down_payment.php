								...
								<div class="row">
									<div class="col-md-12">
										...
										<div class="col-md-4">
											<div class="form-group">
											<label for="down_date"><?= lang('down_date') ?></label>
												 <?php echo form_input('down_date',(isset($order_down->installment_date)?date("d/m/Y",strtotime($order_down->installment_date)):date("d/m/Y")), 'class="form-control date" id="down_date" required="required"'); ?>
											</div>
										</div>
							...
							<div class="col-lg-12">
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<?php echo form_input('jl_dob', (isset($jl_data->date_of_birth) ? date("d/m/Y",strtotime( $jl_data->date_of_birth)) : date("d/m/Y")), 'class="form-control date" id="jl_dob" '); ?>
									</div>													
...
$( document ).ready(function() {	
	var site = <?= json_encode(array('base_url' => base_url(), 'settings' => $Settings, 'dateFormats' => $dateFormats)) ?> 
		...
		$("#depreciation_type_1").trigger("change");
