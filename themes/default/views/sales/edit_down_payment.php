									...
									<div style="float:left;width:100%;">
										<div class="form-group">
											<div class="input-group">  
												<input type="hidden" name="payment_id" value="<?=$down_info->id?>"/>
												<?php echo form_input('reference_no', $reference?$reference:$down_info->reference_no,'class="form-control input-tip spref" id="reference_no" required="required"'); ?>
							...
							<div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="paid_by" id="paid_by_1" class="form-control paid_by"
                                            required="required">
                                        <option <?=($down_info->paid_by=='cash'?"selected":"")?> value="cash"><?= lang("cash"); ?></option>
                                        <option <?=($down_info->paid_by=='CC'?"selected":"")?> value="CC"><?= lang("CC"); ?></option>
                                        <option <?=($down_info->paid_by=='gift_card'?"selected":"")?> value="gift_card"><?= lang("gift_card"); ?></option>
                                        <option <?=($down_info->paid_by=='Cheque'?"selected":"")?> value="Cheque"><?= lang("cheque"); ?></option>
                                        <option <?=($down_info->paid_by=='other'?"selected":"")?> value="other"><?= lang("other"); ?></option>
                                    </select>
                                </div>
                            </div>
								...
								<div class="form-group">
									...
									<?php
                                        ...
                                        if ($Owner || $Admin) {
        									...
        									echo form_dropdown('bank_account', $bank, $down_info->bank_account, 'id="bank_account_1" class="ba form-control kb-pad bank_account" data-bv-notempty="true"');
                                        } else {
                                            ...
                                            echo form_dropdown('bank_account', $ubank, $down_info->bank_account, 'id="bank_account_1" class="ba form-control kb-pad bank_account" data-bv-notempty="true"');
                                        }
									?>
								</div>
                            </div>
