    ...
    $(document).ready(function () {
        ...
        var oTable = $('#SupData').dataTable({
            ...
            "aoColumns": [{
                ...
                "mRender": attachment,
                "mRender": checkbox
            }, null, null, {"mRender": currencyFormatNoZero}, {"mRender": currencyFormatNoZero}, {"mRender": currencyFormatNoZero},{"mRender": currencyFormatNoZero},null ,{"mRender": fld}, {"mRender": fld}, null, {"mRender": house_calendar_status}, {"mRender": attachment}],
            ...
            {column_number: 1, filter_default_label: "[<?=lang('house');?>]", filter_type: "text", data: []},
			...
			{column_number: 5, filter_default_label: "[<?=lang('down_payment');?>]", filter_type: "text", data: []},
			{column_number: 6, filter_default_label: "[<?=lang('loan_amount');?>]", filter_type: "text", data: []},
            {column_number: 7, filter_default_label: "[<?=lang('suspend_desciption');?>]", filter_type: "text", data: []},
			{column_number: 8, filter_default_label: "[<?=lang('start_date');?>]", filter_type: "text", data: []},
            {column_number: 9, filter_default_label: "[<?=lang('end_date');?>]", filter_type: "text", data: []},
			{column_number: 10, filter_default_label: "[<?=lang('term');?>]", filter_type: "text", data: []},
