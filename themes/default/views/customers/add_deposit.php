                ...
                <div class="col-sm-12">
					...
					<?php if ($Owner || $Admin) { ?>
						<div class="form-group">
							...
							echo form_dropdown('biller', $bl, (isset($_POST['biller']) ? $_POST['biller'] : (($so_id > 0) ? $sale_order->biller_id : $this->site->get_setting()->default_biller)), 'class="form-control" id="posbiller" required="required"');
							?>
						</div>
					<?php } else {
						$biller_input = array(
