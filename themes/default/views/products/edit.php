                ...
                <div class="col-md-6 col-md-offset-1">
					...
					<div class="service" style="display:none;">
						<fieldset class="scheduler-border">
							...
							<?= lang('home');?>: <input type="radio" name="service_type" <?= ($product->service_type == 1?'checked':'')?> value="1">
							<?= lang('cost');?>: <input type="radio" name="service_type" <?= ($product->service_type == 2?'checked':'')?> value="2">
						</fieldset>
					</div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
								...
								<?php
									...
									echo form_dropdown('cf1', $ht, $product->cf1, 'class="form-control" id="cf1" placeholder="' . lang("select") . " " . lang("home_type") . '" style="width:100%"')
								?>
                            </div>
                        </div>
